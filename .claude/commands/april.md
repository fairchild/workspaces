...
4. Check runner health on this machine: `./scripts/runners.py` (informational only — this repo has no registered runner and no workflow dispatches to one, so anything it reports blocks nothing)
