...
Last updated: `2026-08-31T13:35:34.669643Z`
Source: `live`
...
- `Factory Review Executor` — 16 failure(s)
...
|---|---:|---:|---:|---:|---:|
| Approved Mention Execution | 75 | 0 | 0.00% | 0 | 0.00% |
| Mention Triage | 33 | 0 | 0.00% | 0 | 0.00% |
...
- #43 — [task] [idea][endorsed] Isolate intrusive CI jobs onto a Tart VM runner lane (112.7 days idle)
- #110 — [idea][endorsed] Fix environment status color semantics in New Workspace sheet (44.0 days idle)
