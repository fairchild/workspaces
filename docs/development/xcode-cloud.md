...
Keep release signing/notarization on the existing GitHub Actions release workflow (hosted `macos-26`) until the Xcode Cloud validation lane has proven stable.
