...
The development-process context: the language of the autonomous loop that advances this repo between the Owner's interactive sessions. Distinct from the product domain in the root `GLOSSARY.md`.
