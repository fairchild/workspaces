...
string_patterns=(
    ...
    WORKSPACES_UI_FIXTURE_SEED_RUNAWAY_ALERT
    WORKSPACES_UI_FIXTURE_OPEN_SESSION_SWITCHER
    WORKSPACES_UI_FIXTURE_OPEN_DIAGNOSTICS
    WORKSPACES_UI_FIXTURE_FILE_TREE_FAILURE
    WORKSPACES_UI_FIXTURE_SIDEBAR_ARRANGEMENT
    WORKSPACES_UI_FIXTURE_CMD_T_REPO
    WORKSPACES_UI_FIXTURE_TRIGGER_CMD_T
    WORKSPACES_UI_FIXTURE_PINNED
    WORKSPACES_UI_FIXTURE_ARCHIVED
    WORKSPACES_UI_FIXTURE_SELECTED
