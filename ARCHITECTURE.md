...
This document covers the macOS app. Two separate Next.js apps in this repo relate to it differently — see `web/AGENTS.md` and `web-next/AGENTS.md` for the full charter:
