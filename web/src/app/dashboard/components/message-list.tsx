		...
		return (
			<div className={styles.empty}>
				...
				<span className={styles.emptyText}>
					No messages yet. Use the compose bar below to dispatch an
					agent or start a conversation.
				</span>
			</div>
		);
	}
	...
	return (
		<div className={styles.message}>
			<div className={styles.messageHeader}>
				<span
					className={`${styles.messageAuthor} ${authorClass}`}
				>
					{message.author}
				</span>
