...
| Automation two-arc: evidence capture → workspace orchestration | Automation | **`[A1]` closed 2026-07-08** (milestone [#16](https://github.com/fairchild/workspaces/milestone/16) — #933/#941/#942/#943; evidence lane live, locked-screen still falls back to VM lanes; SCK migration filed as #944 with an explicit trigger). **`[A2]` active** — milestone [#17](https://github.com/fairchild/workspaces/milestone/17) (verbs = clicks). Decision record: `docs/decisions/automation-operator-scope.md`. |
