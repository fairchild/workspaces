...
|---|---|---|---|
| **Desktop** | **[#10](https://github.com/fairchild/workspaces/milestone/10) — durable sessions** | **[#15](https://github.com/fairchild/workspaces/milestone/15) — product breadth** | [#9](https://github.com/fairchild/workspaces/milestone/9) closed out 2026-07-07: epic #627 **closed** (#690 shipped geometric directional focus, PR #867; follow-ons filed as #872/#873/#874), debt paid (#708/#710/#637/#663/#664/#670/#709 closed), stragglers #696/#666 in flight. #10 is now the **active** desktop milestone (full D-lane completion greenlit 2026-07-07): slices 1–4b of #728 already merged behind the default-off flag; live work is #783 (PR #888 + libghostty finding #889), #789 retention, then #728/#548 close-out and the #729 research tail. [D3] #15 (native edit loop #704, verifiable surfaces #679, mission control #680) follows. |
...
| Durable sessions (reboot / resume / history) | Desktop · `arc:terminal-continuity` | **Active (2026-07-07)** — milestone [#10](https://github.com/fairchild/workspaces/milestone/10), pulled forward once #9's debt cleared (one-active-per-lane). Ground truth from the code audit: slices 1–4b of epic [#728](https://github.com/fairchild/workspaces/issues/728) are merged behind the default-off `restoreSessionsOnLaunch` flag, and #786 already fixed the PATH/run-scoping/manifest findings from #783. In flight: #783 banner guard + working resume delivery (PR #888; surfaced libghostty per-surface command bug #889), #789 restore-aware retention. Then #728/#548 close-out verification and the #729 cloud-handoff research tail. #549 tmux (full path) belongs here — re-scope before pulling it in. |
| Desktop product breadth | Desktop | **Queued #3** — milestone [#15](https://github.com/fairchild/workspaces/milestone/15) `[D3]`: #704 native edit loop, #679 verifiable browser surfaces, #680 mission control. Promoted 2026-07-07 from the "breadth follows debt" theme; queued behind #9/#10. #706 (Pierre diff) stays `idea`. |
...
| Native edit + diff-review loop | product | — · [D3] #15 | [#704](https://github.com/fairchild/workspaces/issues/704) (Pierre enhancement #706 is `idea`) |
| Browser-verifiable embedded web surfaces | product | — · [D3] #15 | [#679](https://github.com/fairchild/workspaces/issues/679) |
| Agent/session mission control + richer metadata | product | — · [D3] #15 | [#680](https://github.com/fairchild/workspaces/issues/680) |
